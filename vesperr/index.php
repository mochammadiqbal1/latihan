  ...
  <body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
          <h1><a href="index.php">CODING PGT</a></h1>
          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="text-center"><button type="submit" name="submit">Simpan</button></div>
              </form>
            </div>
      ...
      <section id="about" class="about">
        <div class="container">
          ...
          <tr>
            ...
            <th style="width:550px">Nama Lengkap</th>
            <th style="width:350px">Tempat Lahir</th>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                while($mhs = mysqli_fetch_array($query)){
                    ?>
                    <?php echo "<td>".$mhs['nama_lengkap']."</td> <br>"; 
                    echo "<td>".$mhs['jurusan']."</td>"; ?>
                    <p>
                      <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                     <?php echo "<td>".$mhs['alamat']."</td>";}?>              
